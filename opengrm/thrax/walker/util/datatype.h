...
#ifndef OPENGRM_THRAX_WALKER_UTIL_DATATYPE_H_
#define OPENGRM_THRAX_WALKER_UTIL_DATATYPE_H_
...
class DataType {
 public:
  ...
  std::unique_ptr<DataType> Copy() const {
    ...
    auto out = absl::WrapUnique(new DataType());
 ...
 private:
  ...
  using ThingType =
      std::variant<::fst::Fst<::fst::StdArc>*, ::fst::Fst<::fst::LogArc>*,
                   ::fst::Fst<::fst::Log64Arc>*, ::fst::SymbolTable,
                   std::string, int>;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_DATATYPE_H_
