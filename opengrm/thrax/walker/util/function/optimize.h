...
#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_OPTIMIZE_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_OPTIMIZE_H_
...
class Optimize : public UnaryFstFunction<Arc> {
 ...
 private:
  Optimize(const Optimize<Arc>&) = delete;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_OPTIMIZE_H_
