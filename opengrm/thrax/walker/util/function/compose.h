...
#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_COMPOSE_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_COMPOSE_H_
...
class Compose : public Function<Arc> {
 ...
 private:
  Compose(const Compose<Arc>&) = delete;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_COMPOSE_H_
