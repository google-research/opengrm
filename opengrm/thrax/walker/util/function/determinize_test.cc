...
#include "opengrm/thrax/walker/util/function/determinize.h"
...
class DeterminizeTest : public ::testing::Test {
 protected:
  ...
  Determinize<Arc> func_;
};

using ArcTypes = ::testing::Types<::fst::StdArc, ::fst::LogArc>;
TYPED_TEST_SUITE(DeterminizeTest, ArcTypes);

TYPED_TEST(DeterminizeTest, TestDeterminize) {
