...
#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_REVERSE_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_REVERSE_H_
...
class Reverse : public UnaryFstFunction<Arc> {
 ...
 private:
  Reverse(const Reverse<Arc>&) = delete;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_REVERSE_H_
