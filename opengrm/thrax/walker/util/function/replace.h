...
#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_REPLACE_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_REPLACE_H_
...
// TODO: Figure out what to do with if we are keeping symbol tables around
...
class Replace : public Function<Arc> {
 ...
 private:
  ...
  Replace(const Replace<Arc>&) = delete;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_REPLACE_H_
