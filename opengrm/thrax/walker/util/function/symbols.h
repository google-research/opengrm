...
#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_SYMBOLS_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_SYMBOLS_H_
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_SYMBOLS_H_
