...
// opengrm/thrax/test/paradigm_test instead.

#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_PARADIGM_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_PARADIGM_H_
...
class Analyzer : public Function<Arc> {
 ...
 private:
  Analyzer(const Analyzer<Arc>&) = delete;
...
class Tagger : public Function<Arc> {
 ...
 private:
  Tagger(const Tagger<Arc>&) = delete;
...
class ParadigmReplace : public Function<Arc> {
 public:
  ...
  ParadigmReplace() = default;
  ~ParadigmReplace() final = default;
 ...
 private:
  ParadigmReplace(const ParadigmReplace<Arc>&) = delete;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_PARADIGM_H_
