...
#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_FUNCTION_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_FUNCTION_H_
...
class Function {
 ...
 private:
  Function(const Function<Arc>&) = delete;
...
class UnaryFstFunction : public Function<Arc> {
 public:
  ...
  UnaryFstFunction() = default;
  ~UnaryFstFunction() override = default;
...
class BinaryFstFunction : public Function<Arc> {
 public:
  ...
  BinaryFstFunction() = default;
  ~BinaryFstFunction() override = default;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_FUNCTION_H_
