...
#ifndef OPENGRM_THRAX_WALKER_UTIL_FUNCTION_DIFFERENCE_H_
#define OPENGRM_THRAX_WALKER_UTIL_FUNCTION_DIFFERENCE_H_
...
class Difference : public BinaryFstFunction<Arc> {
 ...
 protected:
  std::unique_ptr<Transducer> BinaryFstExecute(
    ...
    constexpr auto kRightInputProps = ::fst::kAcceptor | ::fst::kUnweighted;
 ...
 private:
  Difference(const Difference<Arc>&) = delete;
...
#endif  // OPENGRM_THRAX_WALKER_UTIL_FUNCTION_DIFFERENCE_H_
