...
syn keyword thraxBuiltinFunctions Analyzer AssertEmpty AssertEqual AssertNull CDRewrite Category Closure Compose Concat Determinize Difference Feature FeatureVector Invert LenientlyCompose LoadFst LoadFstFromFar Minimize MPdtCompose Optimize ParadigmReplace PdtCompose Project Replace Reverse Rewrite RmEpsilon RmWeight StringFile StringFst SymbolTable Tagger Union
