...
#ifndef OPENGRM_THRAX_AST_RULE_NODE_H_
#define OPENGRM_THRAX_AST_RULE_NODE_H_
...
class RuleNode : public Node {
 public:
  ...
  RuleNode(std::unique_ptr<IdentifierNode> name, std::unique_ptr<Node> rhs,
           ExportStatus exp);
...
#endif  // OPENGRM_THRAX_AST_RULE_NODE_H_
