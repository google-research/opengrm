...
class FeaturesTest(absltest.TestCase):
  ...
  def testFeatureVector(self):
    ...
    self.assertSameElements(
        fvm.paths().ostrings(),
        (
            "[case=dat][gen=fem][num=sg]",
            "[case=dat][gen=mas][num=sg]",
...
class FeatureFillerTest(absltest.TestCase):
  ...
  def testFeatureFiller(self):
    ...
    self.assertSameElements(
        cat.paths().ostrings(),
        [
            "[case=nom][gen=n/a][num=sg]",
            "[case=nom][gen=n/a][num=pl]",
            "[case=gen][gen=n/a][num=sg]",
            "[case=gen][gen=n/a][num=pl]",
            "[case=dat][gen=n/a][num=sg]",
            "[case=dat][gen=n/a][num=pl]",
            "[case=acc][gen=n/a][num=sg]",
            "[case=acc][gen=n/a][num=pl]",
        ],
    )
