...
def rewrite_lattice(
  ...
  """
  # TODO: Consider adding support for PDT and MPDT composition.
  # TODO: Consider using `contextlib.nullcontext` here instead.
...
def lattice_to_dfa(
    lattice: pynini.Fst, optimal_only: bool, state_multiplier: int = 4
) -> pynini.Fst:
