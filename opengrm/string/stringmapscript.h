...
#ifndef OPENGRM_STRING_STRINGMAPSCRIPT_H_
#define OPENGRM_STRING_STRINGMAPSCRIPT_H_
...
using FstStringFileCompileInnerArgs =
    std::tuple<absl::string_view, MutableFstClass*, TokenType, TokenType,
...
using FstStringMapCompileInnerArgs1 =
    std::tuple<absl::Span<const std::vector<std::string>>, MutableFstClass*,
...
using FstStringMapCompileInnerArgs2 = std::tuple<
    absl::Span<const std::tuple<std::string, std::string, WeightClass>>,
...
#endif  // OPENGRM_STRING_STRINGMAPSCRIPT_H_
