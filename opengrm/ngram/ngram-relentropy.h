...
#ifndef OPENGRM_NGRAM_NGRAM_RELENTROPY_H_
#define OPENGRM_NGRAM_NGRAM_RELENTROPY_H_
...
class NGramRelEntropy : public NGramShrink<fst::StdArc> {
 public:
  ...
  // entropy criterion.
  NGramRelEntropy(fst::StdMutableFst* infst, double theta, int shrink_opt = 0,
...
#endif  // OPENGRM_NGRAM_NGRAM_RELENTROPY_H_
