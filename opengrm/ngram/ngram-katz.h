...
#ifndef OPENGRM_NGRAM_NGRAM_KATZ_H_
#define OPENGRM_NGRAM_NGRAM_KATZ_H_
...
class NGramKatz : public NGramMake<Arc> {
 public:
  ...
  bool MakeNGramModel() override {
    ...
    CalculateDiscounts();
    if (VLOG_IS_ON(1)) count_of_counts_.ShowCounts(discount_, "Katz discounts");
 ...
 private:
  ...
  double SaneKatzRNorm(int order) const {
...
#endif  // OPENGRM_NGRAM_NGRAM_KATZ_H_
