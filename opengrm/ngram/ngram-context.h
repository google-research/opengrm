...
#ifndef OPENGRM_NGRAM_NGRAM_CONTEXT_H_
#define OPENGRM_NGRAM_NGRAM_CONTEXT_H_
...
class NGramContext {
 public:
  ...
  //   {1,1,1,1} and an end context vector of {1,1,1,5}. See next constructor
...
class NGramExtendedContext {
 public:
  ...
  const NGramContext* absl_nullable GetContext(
...
bool NGramWriteContexts(const std::string& file,
                        absl::Span<const std::string> contexts);
...
void NGramContext::FindContexts(
  ...
  absl::flat_hash_map<typename Arc::Label, size_t> bigram_counts;
...
#endif  // OPENGRM_NGRAM_NGRAM_CONTEXT_H_
