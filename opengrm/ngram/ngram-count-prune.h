...
#ifndef OPENGRM_NGRAM_NGRAM_COUNT_PRUNE_H_
#define OPENGRM_NGRAM_NGRAM_COUNT_PRUNE_H_
...
class NGramCountPrune : public NGramShrink<fst::StdArc> {
 public:
  ...
  NGramCountPrune(fst::StdMutableFst* infst, const std::string& count_pattern,
  ...
  NGramCountPrune(fst::StdMutableFst* infst,
                  absl::Span<const double> count_minimums, int shrink_opt = 0,
...
#endif  // OPENGRM_NGRAM_NGRAM_COUNT_PRUNE_H_
