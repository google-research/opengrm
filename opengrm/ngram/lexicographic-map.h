...
#ifndef OPENGRM_NGRAM_LEXICOGRAPHIC_MAP_H_
#define OPENGRM_NGRAM_LEXICOGRAPHIC_MAP_H_
...
inline constexpr int32_t kBackoffPenalty = 2;
...
#endif  // OPENGRM_NGRAM_LEXICOGRAPHIC_MAP_H_
