...
#ifndef OPENGRM_NGRAM_NGRAM_CONTEXT_PRUNE_H_
#define OPENGRM_NGRAM_NGRAM_CONTEXT_PRUNE_H_
...
class NGramContextSeymoreShrink : public NGramSeymoreShrink {
 ...
 private:
  ...
  NGramContextSeymoreShrink& operator=(const NGramContextSeymoreShrink&) =
      delete;
};

}  // namespace ngram

#endif  // OPENGRM_NGRAM_NGRAM_CONTEXT_PRUNE_H_
