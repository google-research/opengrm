...
#ifndef OPENGRM_NGRAM_HIST_ARC_H_
#define OPENGRM_NGRAM_HIST_ARC_H_
...
struct HistogramArc : public fst::PowerArc<fst::StdArc, kHistogramBins> {
...
#endif  // OPENGRM_NGRAM_HIST_ARC_H_
