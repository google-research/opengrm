...
#ifndef OPENGRM_NGRAM_NGRAM_MODEL_MERGE_H_
#define OPENGRM_NGRAM_NGRAM_MODEL_MERGE_H_
...
class NGramModelMerge : public NGramMerge<fst::StdArc> {
 public:
  ...
  explicit NGramModelMerge(fst::StdMutableFst* infst1, Label backoff_label = 0,
...
#endif  // OPENGRM_NGRAM_NGRAM_MODEL_MERGE_H_
